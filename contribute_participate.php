...
<html lang="en">
    <head>
        ...
        <title>Moodlink - Participer</title>
    </head>
    <body>
        ...
        <section class="about py-5 mx-3">
            <div class="container py-md-3">
                ...
                <h4 class="about-left">
                    ...
                    <br>Vous souhaitez contribuer au développement de la solution ?
                </h4>
                <p class="my-sm-4 my-3">
                    Ecrivez-nous et nous tâcherons de vous répondre dans les plus brefs délais.
                </p>
                            ...
                            <form action="https://gmail.us2.list-manage.com/subscribe/post?u=204b911fb2a3858d052a8651d&amp;id=f80cf58748" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                                <div id="mc_embed_signup_scroll">
                                    <div class="row">
                                        ...
                                        <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_204b911fb2a3858d052a8651d_f80cf58748" tabindex="-1" value=""></div>
                                        <div class="col-md-12">
                                            <div class="submit-buttons">
                                                <button type="submit" class="btn" id="mc-embedded-subscribe">Envoyer</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
